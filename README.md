...
![3](res/3.png)
4) __Вам необходимо нарисовать что-нибудь пока не будет достигнут прогресс в 100%__
![4](res/4.png)
5) __Нажмите кнопку со значком "галочка"__
![5](res/5.png)
6) __Введите любое название и нажмите кнопку "Принять", а затем нажмите на значок "открытый замок" внизу экрана__
![6](res/6.png)
7) __Нажмите на появившейся ключ__
![7](res/7.png)
...
11) __Отправтье скопированный текст Вашему администратору любым доступным способом: мессенджер, СМС, почта__

### Получение сообщений от администратора
1) __Нажмите на Ваш ключ (тот, что Вы создали ранее)__
![1](res/7.png)
2) __Выберете пункт "Расшифровать"__
![2](res/10.png)
3) __Скопируйте сообщение от администратора и вставьте в приложение__
![3](res/11.png)
